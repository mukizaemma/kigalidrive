...
<section class="py-5 mt-4">
    <div class="container col-lg-8">
        <h1 class="kdr-section-title mb-2">List Your Car or Apartment</h1>
        <p class="text-muted mb-4">Share a few details — our team in Kisimenti will review and contact you before anything goes live.</p>
