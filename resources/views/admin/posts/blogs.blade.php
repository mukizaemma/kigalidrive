            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <div>
                            <h5 class="mb-1">Articles &amp; updates</h5>
                            <p class="text-muted small mb-0">Publish articles, track views, and moderate comments before they go live.</p>
                        </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <textarea id="Blogs" rows="5" class="form-control summernote" name="body"></textarea>
                                            </div>
                                        </div>
