            ...
            <div class="bg-light rounded p-4 mb-4">
                ...
                <form action="{{ route('admin.facility-categories.update', $category->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control summernote @error('description') is-invalid @enderror" rows="3">{!! old('description', $category->description) !!}</textarea>
